 ...
 * ActuatorDataTest. It should not be considered complete,
...
public class ActuatorDataTest
{
	...
	public void testDefaultValues()
	{
		...
		assertTrue(ad.getCommand() == ActuatorData.DEFAULT_COMMAND);
		assertTrue(ad.getValue() == ActuatorData.DEFAULT_VAL);
	}
